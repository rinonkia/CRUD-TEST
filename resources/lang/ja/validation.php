...
return [
    ...
    */
    ...
    'confirmed' => ':attribute は確認用の項目と一致していません。',
    'date' => ':attribute は正しい日付ではありません。',
    'date_equals' => ':attribute は :date でなければいけません。',
    'date_format' => ':attribute は :format 書式と一致しなければいけません。',
    'different' => ':attribute は :other と違うものでなければいけません。',
    ...
    'gt' => [
        ...
        'file' => ':attribute は :value KBより大きなファイルにしてください。',
    ...
    'ip' => ':attribute は正しいIPアドレスにしてください。',
    'ipv4' => ':attribute は正しいIPv4アドレスにしてください。',
    'ipv6' => ':attribute は正しいIPv6アドレスにしてください。',
    ...
    'not_regex' => ':attribute の書式は不正です。',
    'numeric' => ':attribute は数字にしてください。',
    'present' => ':attribute は存在する必要があります。',
    'regex' => ':attribute の書式は不正です。',
    'required' => ':attribute は必須です。',
    'required_if' => ':other が :value の場合、:attribute は必須です。',
    'required_unless' => ':other が :value にない場合、:attribute は必要です。',
    'required_with' => ':value が存在する場合、:attribute は必須です。',
    'required_with_all' => ':value が存在する場合、:attribute は必須です。',
    'required_without' => ':value が存在しない場合、:attribute は必須です。',
    'required_without_all' => ':value が存在しない場合、:attribute は必須です。',
    'same' => ':attribute と :other が一致していません。',
    'size' => [
        'numeric' => ':attribute は :size にしてください。',
        'file' => ':attribute は :size KBのファイルにしてください。',
        'string' => ':attribute は :size 文字にしてください。',
        'array' => ':attribute は :size 個にしてください。',
    ],
    'string' => ':attribute は文字列にしてください。',
    'timezone' => ':attribute は正しいタイムゾーンにしてください。',
    'unique' => ':attribute は既に存在しています。',
    'uploaded' => ':attribute はアップロードできませんでした。',
    'url' => ':attribute を正しい書式にしてください。',
    'uuid' => ':attribute を正しいUUIDにしてください。',
